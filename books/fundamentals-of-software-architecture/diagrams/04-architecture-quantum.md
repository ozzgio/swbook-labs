...
flowchart LR
    ...
    linkStyle 1 stroke:#ff9933,stroke-width:2.5px
...
**Read left to right:** Auctioneer (Q2) opens the session → Bidder (Q3) captures bids → Bidder Feedback (Q1) streams state to all viewers. No arrows cross.
